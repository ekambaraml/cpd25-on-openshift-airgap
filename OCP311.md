...
* [ ] 12. Reboot all cluster nodes
	...
	<b> Please ensure, "manage_etc_hosts: False" is set to false in the file "/etc/cloud/cloud.cfg" to prevent your  /etc/hosts file changes from overwritten by by default /etc/host entries</b>.
