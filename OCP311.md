...
| Load Balancer|1 option| <ul><li>4 Core</li><li>8GB Ram</li><li>RHEL 7.5+</li></ul>|<ul><li> 100 GB Root</li><li> or This required for running Infra on the LB node /var/lib/containers </li></ul>|Virtual Machine local load balancer|
